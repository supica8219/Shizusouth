// Define cache name
const cacheName = 'shizusouth-pwa-cache202518';

const filesToCache = 
['/img/shizusouth_logo_192.png','/img/bus.svg','/img/train.svg','/img/menu.svg','/img/kurogane3.png']
// Trigger update of the service worker
